...
function FileStatusIcon({ status }: { status: string }) {
  switch (status) {
    ...
    default:
      return <FileEdit className="w-3 h-3 text-muted-foreground" />
  }
}
      ...
      <div className="px-3 py-2 border-b border-border">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1.5 text-xs">
            ...
            <span className="font-mono font-medium text-foreground">{currentBranch}</span>
      ...
      <div className="px-3 py-2 space-y-3">
          ...
          {(commitsAhead > 0 || changedFiles.length > 0) && (
            <div className="flex items-center gap-2 text-[10px]">
              {commitsAhead > 0 && (
                <span className="px-1.5 py-0.5 bg-green-500/10 text-green-600 rounded">
              ...
              {changedFiles.length > 0 && (
                <button
                  ...
                  className="px-1.5 py-0.5 bg-amber-500/10 text-amber-600 rounded hover:bg-amber-500/20 transition-colors"
                >
          ...
          {showFiles && changedFiles.length > 0 && (
            <div className="bg-secondary rounded p-2 space-y-0.5 max-h-32 overflow-y-auto">
